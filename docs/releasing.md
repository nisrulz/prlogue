...
Tags matching `v*` start the release workflow. It uses the Go version pinned in `go.mod` and runs formatting, module, race, vet, and vulnerability checks before GoReleaser starts.
